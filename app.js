...
app.use(session({
    ...
    resave: false, saveUninitialized: true, cookie: {secure: "auto", maxAge: 3600000}, // secure: 'auto' will use secure cookies if the site uses HTTPS
}));
...
app.post("/print-report", async (req, res) => {
    ...
    try {
        ...
        doc
            ...
            .moveDown()
            .text(`Cost for ${distanceKm} km Distance: $${distanceCost.toFixed(2)}`, {indent: 30})
            .moveDown();
